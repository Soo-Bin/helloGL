...
shader = shaders.compileProgram(vertex_shader, tess_shader, tess_evaluation_shader, fragment_shader)

# -1에서 1사이의 랜덤한 정점 좌표 생성
vertices = np.random.uniform(-1.0, 1.0, (15, 3)).astype(np.float32)
